        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SharedFileId = table.Column<string>(type: "TEXT", maxLength: 64, nullable: false),
                    ...
                    IsTombstoned = table.Column<bool>(type: "INTEGER", nullable: false),
                    TombstonedAt = table.Column<string>(type: "TEXT", nullable: true)
                },
                constraints: table =>
                {
