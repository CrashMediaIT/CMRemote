...
— concrete WebRTC capture / encode driver lands in a follow-up
slice once the ADR is decided, without any further dispatch or
wire churn),
the first
